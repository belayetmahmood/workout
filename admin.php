    ...
    <h3>
      <?php
        if($row2['is_completed'] == 1){
          echo "You have completed this plan!";
        } else {
          echo "You have't completed this plan yet";
        }
        ...
        date_add($date,date_interval_create_from_date_string("7 day"));
        $last_day = date_format($date,"Ymd");
        $days_left = date('N', strtotime($last_day));

      ?>
    </h3>
    <p>
      You have <?php echo $days_left; ?> days left
    </p>
      ...
      <div class="container" style="margin-top: 100px; margin-bottom: 100px;">
        ...
        <div class="row setup-content step activeStepInfo" id="step-1">
            <div class="col-xs-12">
                ...
                <button  class="btn btn-success pull-right" onclick="javascript: resetActive(event, 20, 'step-2');">Proceed to Next Step </button>
                <!-- <form class="" action="progress_step.php" method="post">
                  <input type="hidden" name="progress" value="1">
                  <button id="progress" class="btn btn-success pull-right">Submit</button>
                </form> -->
            </div>
        </div>
            ...
            <div class="col-xs-12">
                <?php
                  ...
                  if($days_left <= 5){
                    ...
                    <button  class="btn btn-success pull-right" onclick="javascript: resetActive(event, 40, 'step-3');">Proceed to Next Step </button>
                    <?php
                  }
                  else{
                    ?>
                    <h3>Please complete previous day or wait for the next day</h3>
                    <?php
                  }
            ...
            <div class="col-xs-12">
              <?php
                ...
                if($days_left <= 4){
                  ...
                  <button  class="btn btn-success pull-right" onclick="javascript: resetActive(event, 60, 'step-4');">Proceed to Next Step </button>
                  <?php
                }
                else{
                  ?>
            ...
            <div class="col-xs-12">
              <?php
                ...
                if($days_left <= 3){
                  ...
                  <button  class="btn btn-success pull-right" onclick="javascript: resetActive(event, 80, 'step-5');">Proceed to Next Step </button>
                  <?php
                }
                else{
                  ?>
            ...
            <div class="col-xs-12">
              <?php
                ...
                if($days_left <= 2){
                  ...
                  <button class="btn btn-success pull-right" onclick="javascript: resetActive(event, 100, 'step-6');">Proceed to Next Step </button>
                  <?php
                }
                else{
                  ?>
            ...
            <div class="col-xs-12">
              <?php
                ...
                if($days_left <= 1){
                  ...
                  <button id="submit_complete" class="btn btn-success pull-right" onclick="">Complete Process </button>
                  <?php
                }
                else{
                  ?>
